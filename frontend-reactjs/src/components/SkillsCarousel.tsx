              ...
              return (
                ...
                >
                  <a href={element.skillsLink} target='_blank'>
                    <img
                      className='h-[100px] w-[100px] object-cover rounded-xl pointer-events-none dark:hidden'
                      src={urlFor(element.skillsImage).toString()}
                      alt={element.skillsTitle}
                    />
                    <img
                      className='h-[100px] w-[100px] object-cover rounded-xl pointer-events-none hidden dark:block'
