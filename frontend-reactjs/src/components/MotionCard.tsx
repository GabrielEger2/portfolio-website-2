        ...
        {isOpen ? (
          <motion.div>
            <div>
              <motion.h2
                layout='position'
                className={`font-bold  items-center text-center justify-center pt-1 ${position === 'right' || position === 'left' ? 'flex' : ''} space-x-4 text-xl text-gray-800 dark:text-gray-200`}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                        ...
                        <div key={data.educationTitle} className='max-w-[600px] text-left'>
                          <ol className="relative border-l border-gray-400 dark:border-gray-900 pb-10">                  
                            <li className="ml-4">
                                ...
                                <h1 className="mb-1 text-sm font-normal leading-none text-gray-700 dark:text-gray-200">
                                  {data.educationDate}
                                </h1>
                                <h3 className="text-lg pb-1 font-bold text-gray-800 dark:text-gray-100">{data.educationTitle}</h3>
                                <p className=" text-base font-normal text-gray-700 dark:text-gray-200">{data.educationDescription}</p>
                            </li>
                          </ol>
                        </div>
                      ))}
          ...
          <motion.h2
            layout='position'
            className='font-bold min-w-20 sm:w-44 md:w-48 h-32 text-md text-center md:text-xl z-50 text-gray-800 dark:text-gray-200'
          >
